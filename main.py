...
count_timer = canvas.create_text(100, 130, text='00:00', fill='white', font=(FONT_NAME, 30, "bold"))
...
start_button = Button(text="Start", highlightthickness=0, command=add_timer)
